...
import { speedDialFabAnimations } from './speed-dial-fab-button.animations';
...
@Component({
  ...
  templateUrl: './speed-dial-fab-button.component.html',
  styleUrls: ['./speed-dial-fab-button.component.scss'],
  animations: speedDialFabAnimations
})
export class SpeedDialFabButtonComponent {
